<template>
  <div class="xtx-pagination">
    <a href="javascript:;" @click="changePage(1)" :class="{disabled: myCurrentPage === 1}">首页</a>
    ...
    <a href="javascript:;" @click="changePage(pager.pageCount)" :class="{disabled: myCurrentPage === pager.pageCount}">尾页</a>
  </div>
</template>
<script>
